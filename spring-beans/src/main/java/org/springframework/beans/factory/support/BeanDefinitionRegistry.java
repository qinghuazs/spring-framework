 ...
 *
 * Spring的bean definition readers希望能够在这个接口的实现上工作。
 *
 * Spring core模块中的已知实现者是DefaultListableBeanFactory和GenericApplicationContext。
 *
...
public interface BeanDefinitionRegistry extends AliasRegistry {
	 ...
	 * @throws BeanDefinitionStoreException 如果BeanDefinition无效7
